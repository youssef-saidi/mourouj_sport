...
<div className="text-left flex bg-white py-5 select-none  ">
   ...
   <p className="md:absolute md:right-0   md:text-right text-center  w-full   font-extralight mt-2 mr-5"> Beta Version</p>
    <button  onClick={ShowNavbar}  class="text-black  mr-8 mb-3  rounded md:hidden ml-auto" >
        ...
        <div className={ShowNav ? "  md:m-auto    py-10 md:py-0    flex md:flex-row flex-col   links  font-bold z-20 select-none " : " select-none    md:m-auto  py-10 md:py-0    font-bold  flex md:flex-row flex-col links active z-20  "}>
