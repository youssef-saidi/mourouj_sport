...
const Navbar = () => {
    ...
    return (
        ...
        <nav className= "text-blue-4 fixed flex md:flex-row flex-col md:bg-white top-0  md:h-auto h-0 w-full z-30 cursor-pointer md:shadow-2xl" >
...
<div className="text-left flex bg-white py-5  ">
   ...
   <p className="md:absolute md:right-0   md:text-right text-center  w-full   font-extralight mt-2 mr-5"> Beta Version</p>
    <button  onClick={ShowNavbar}  class="text-black  mr-8 mb-3  rounded md:hidden ml-auto" >
        ...
        <NavLink  to="/OurTeam" className="px-4 " activeClassName="coloritem">Our Team</NavLink>
        <NavLink exact to="/About" className="px-4 "  activeClassName="coloritem">About</NavLink>
        <NavLink  to="/Training" className="px-4 " activeClassName="coloritem">Training</NavLink>
        <NavLink  to="/Gallery" className="px-4 " activeClassName="coloritem">Gallery</NavLink>
